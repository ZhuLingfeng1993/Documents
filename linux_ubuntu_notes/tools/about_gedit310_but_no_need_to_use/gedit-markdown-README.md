...
>* In Ubuntu16.04,the **default version** of gedit is 3.18,so,you have to **install gedit 3.10**to use this markdown plugin.

>* When I install classborwser plugin,it install gedit310 automaitically,so I can use this markdown plugin
